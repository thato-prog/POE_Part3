...
{//start of namespace
    ...
    {//start of the class
        ...
        string connection = @"Data source=(localdb)\MSSQLLocalDB;Database=tasks_prog";
            ...
            {//start of using
                ...
                {//start of try
                    ...
                    string createTableQuery = @"
                        IF NOT EXISTS (SELECT * FROM sysobjects WHERE name='poe_tasks' AND xtype='U')
                        BEGIN
        ...
        {//start of insert method
            ...
            {//start of using
                ...
                //do the query
                string query = $"insert into poe_tasks values('{name}','{description}','{dueDate}','{status}');";
 ...
 */
            ...
            string query = $"select * from poe_tasks;";
        ...
        {//start of update_taskStatus method
            ...
            //temp variable to hold the query
            string query = $"update poe_tasks set task_status='done' where task_id={id}";
        ...
        {//start of delete_task method
            ...
            //temp variable to hold the query
            string query = $"delete from poe_tasks where task_id={id}";
